...
![AI Agent Diagram](images/agent-diagram.png){#fig-ai-agent fig-cap="An AI Agent processes a query using reasoning (LLM), memory, and tools to produce an action." fig-align="center" width="70%"}
